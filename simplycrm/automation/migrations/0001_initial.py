    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='webhook_events', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='automation.campaign')),
            ],
            options={
                'ordering': ['position'],
            },
