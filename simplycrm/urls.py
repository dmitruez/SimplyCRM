...
urlpatterns = [
	...
	path("admin/", admin.site.urls),
        ...
        path("api/catalog/", include("simplycrm.catalog.urls")),
        path("api/sales/", include("simplycrm.sales.urls")),
        path("api/analytics/", include("simplycrm.analytics.urls")),
        path("api/automation/", include("simplycrm.automation.urls")),
        path("api/integrations/", include("simplycrm.integrations.urls")),
        path("api/assistant/", include("simplycrm.assistant.urls")),
