    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='model_runs', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            name='Insight',
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='insights', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            name='Forecast',
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forecasts', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            name='DataSyncLog',
            fields=[
                ...
                ('data_source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sync_logs', to='analytics.datasource')),
            ],
        ),
        migrations.CreateModel(
            name='Dashboard',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='segments', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metric_definitions', to='core.organization')),
            ],
            options={
                'ordering': ['code'],
